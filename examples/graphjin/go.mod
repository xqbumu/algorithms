module algorithms/examples/graphjin

go 1.22.4

require (
	github.com/dosco/graphjin/serv/v3 v3.0.0-20240522074417-dd3793f4a7b2
...
require (
	...
	github.com/dosco/graphjin/core/v3 v3.0.0-20240522074417-dd3793f4a7b2 // indirect
